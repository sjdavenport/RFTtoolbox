function obj = wlfield( varmask, fibersize, scale, xvals )
% wlfield( varmask, fibersize, df, xvals ) constructs a Fields object of
% white Laplacian noise
%--------------------------------------------------------------------------
% ARGUMENTS
% Mandatory
...
if islogical( varmask)
    obj = Field( varmask );
    obj.field = rlap( scale, [ obj.masksize(1:obj.D) fibersize ] );    
else
    obj = Field( varmask );
    obj.field = rlap( scale, [ obj.masksize(1:obj.D) fibersize ] );
end
