function coverage = boot_rc( data, sample_size, params, mask, niters, do_spm )
...
% function lat_data = get_sample_fields_dep(data, mask, nsubj, with_rep, total_nsubj, D, index)
...
%     spfn = @(nsubj) get_sample_fields_dep(data, mask, nsubj, with_rep, total_nsubj, D, indexD);
% elseif ischar(data)
