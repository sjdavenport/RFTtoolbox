%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%
%%%%    This script tests the convfield_class2.m function
%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% prepare workspace
clear all
...
[ smY, xvals_vecs ] = convfield_class2( Y, FWHM, resAdd, D, 0, 0 );
DsmY = convfield_class2( Y, FWHM, resAdd, D, 1, 0 );
...
%%%% convolution fields function
[ smY, xvals_vecs ] = convfield_class2( Y, FWHM, resAdd, D, 0 );
DsmY = convfield_class2( Y, FWHM, resAdd, D, 1 );

%%%% awsome that still works!
[ maxdiff( smY_old, smY ),...
maxdiff( smYx_old, DsmY(:,:,:,1) ),...
maxdiff( smYy_old, DsmY(:,:,:,2) ) ]
...
%%%% convolution fields function
[ smY, xvals_vecs ] = convfield_class2( Y, FWHM, resAdd, D );
DsmY = convfield_class2( Y, FWHM, resAdd, D, 1 );
